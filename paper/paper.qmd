---
title: "The Influence of Swing States on Election Outcomes"
author: 
  - Tara Chakkithara
  - Sakura Hu
  - Luka Tosic
...
ggplot(density_data, aes(x = x, y = density, color = label)) +
  geom_line(size = 1) +
  labs(
    title = "Distribution of Donald Trump's Electoral College Seat Proportion",
    x = "Probability",
    y = "Density",
    color = "Distribution"
  ) +
