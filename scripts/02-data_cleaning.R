#### Preamble ####
# Purpose: Clean the election data from FiveThirtyEight for the 2024 election. 
...
# For our analysis we will only be looking at swing states and two of
# the election candidates : Donald Trump and Kamala Harris. 
...
# Finally we can just look at the variables swing state, candidate_name, and pct
# for our analysis. 

data <- data |>
  select(swing_state, candidate_name, pct)
